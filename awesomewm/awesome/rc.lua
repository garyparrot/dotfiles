...
terminal = "kitty"
editor = "nvim" -- os.getenv("EDITOR") or "editor"
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "#122", function() volumeWidget.volumeManager:volumeAdd(-5) end,
              {description="降低音量", group = "Function"}),
    awful.key({}, "#123", function() volumeWidget.volumeManager:volumeAdd(5) end,
    ...
    awful.key({ modkey }, "i", function() awful.spawn("rofi-wifi-menu.sh") end,
              {description="Network Menu", group = "Function"}),
    awful.key({ modkey }, "Tab", function() awful.spawn("rofi -show window") end,
              {description="Window switcher", group = "Function"}),
